    ...
    namespace Graphics
    {
        ...
        public struct Vertex
        {
           ////////////////////////////////////////////////////////////
            ...
            /// </summary>
            /// <param name="position">Vertex position</param>
            /// <param name="textureCoordinates">Vertex texture coordinates</param>
            ////////////////////////////////////////////////////////////
            public Vertex(Vector2f position, Vector2f textureCoordinates) :
                this(position, Color.White, textureCoordinates)
            {
            }
            ...
            /// <param name="textureCoordinates">Vertex texture coordinates</param>
            ////////////////////////////////////////////////////////////
            public Vertex(Vector2f position, Color color, Vector2f textureCoordinates)
            {
                Position = position;
                Color = color;
